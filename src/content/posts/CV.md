---
title: "Mon profil en quelques lignes : Support IT, Admin & Dev"
...
📍 Berriche, Oum El Bouaghi, Algérie ·
...
| Domaine | Détails |
|---|---|
| **Systèmes d'exploitation** | Linux (bases de l'administration), Windows (installation, configuration, dépannage) |
| **Réseaux** | Notions fondamentales des réseaux — certifié *Cisco Networking Fundamentals* |
| **Web / Scripting** | HTML, CSS, JavaScript, Python |
| **Cybersécurité** | En cours d'apprentissage — fondamentaux, vulnérabilités des applications web, audit d'applications web |
| **Bureautique & Admin** | Frappe rapide et précise, saisie de données, gestion de documents, gestion des tickets/demandes |
| **Langues** | Anglais (courant), Arabe (langue maternelle), Français (notions de base) |
| **Soft skills** | Communication, souci du détail, résolution de problèmes, gestion du temps, adaptabilité, apprentissage rapide |
...
### Licence en Anglais
**Département des Lettres et de la Littérature, Université Larbi Ben M'hidi d'Oum El Bouaghi**
*Juin 2024*
